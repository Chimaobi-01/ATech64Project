...
export default function Tweet({ image, image1 }) {
  return (
    <div className='flex flex-col px-8 py-4 mb-16 bg-white rounded-2xl'>
      <div className='flex justify-between items-center px-1 pb-6'>
        <div className='flex gap-2 items-center'>
          <img className=" w-10 h-10 rounded-full" src={image} alt='user-photo' />
          <div>
      ...
      <figure>
        ...
        <figcaption className='flex justify-between items-center border-b pb-2 pt-6 px-1.5  text-gray-900 text-base font-medium leading-tight'>
